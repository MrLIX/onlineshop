...
use app\models\search\DeliveryPriceSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DeliveryPriceController implements the CRUD actions for DeliveryPrice model.
 */
class DeliveryPriceController extends Controller
{
    ...
    {
        $searchModel = new DeliveryPriceSearch();
