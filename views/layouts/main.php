            ...
            <div class="ft_info">
                ...
                <div class="ft_info_it">
                    <div class="ft_info_app">
                        <a href="#" class="base_btn border_white" data-toggle="modal" data-target="#app"><?= Yii::t('app','оставить заявку') ?></a>
                    </div>
                </div>
...
<!-- |========== Swal for Application ==========| -->
<input class="hidden" value="<?= Yii::t('app', 'Спасибо!') ?>" id="swal11">
<input class="hidden" value="<?= Yii::t('app', 'Ваше сообщение отправлено') ?>" id="swal21">
<?php if(Yii::$app->session->hasFlash('app')): ?>
    <?php $this->registerJs('
                                var swal_a = $("#swal11").val();
                                var swal_b = $("#swal21").val();
...
<!-- |========== Swal Login ==========| -->
<input class="hidden" value="<?= Yii::t('app', 'Не правильный логин или пароль!') ?>" id="swal111">
<input class="hidden" value="<?= Yii::t('app', 'Попробуйте сново') ?>" id="swal211">
<?php if(Yii::$app->session->hasFlash('loginError')): ?>
    <?php $this->registerJs('
                                var swal_a = $("#swal111").val();
                                var swal_b = $("#swal211").val();
                                swal(swal_a, swal_b, "warning");
                                '); ?>
...
<!-- |=================================== Application Modal  ===================================| -->
<div class="modal fade base_modal model-reg" id="app">
    <div class="modal-dialog">
        <div class="modal-content">
            <button type="button" class="base_modal_close" data-dismiss="modal">
                <i class="fas fa-times"></i>
            ...
            <div class="modal-body">
                <?php ActiveForm::begin(['action' => Url::to(['site/application']), 'method' => 'post']); ?>

                <div class="base_modal_hd"><?= Yii::t('app','оставить заявку') ?></div>
                ...
                <div class="base_modal_bd">
                    <div class="base_modal_fld">
                        ...
                        <div class="psnl_data_gr">
                            <?= Html::input('text', 'name', '',['class'=> 'reg_pop_inp base_modal_inp', 'required' => true, 'placeholder' => Yii::t('app','* Имя') ]) ?>
                        </div>

                        <div class="psnl_data_gr">
                            <?= Html::input('email', 'email', '',['class'=> 'reg_pop_inp base_modal_inp','required' => true,'placeholder' => Yii::t('app','* E-mail')]) ?>
                        </div>

                        <div class="psnl_data_gr">
                            <?= Html::textarea( 'massege', '',['style' => 'height:100px','class'=> 'reg_pop_inp base_modal_inp','required' => true,'placeholder' => Yii::t('app','* Сообщение')]) ?>
                        </div>
                ...
                <div class="base_modal_ft">
                    <button type="submit" class="base_btn solid_violet"><?= Yii::t('app','Отправить') ?>
                    </button>
                </div>
                <?php ActiveForm::end(); ?>
            </div>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/5b3f47064af8e57442dc6435/default';
        s1.charset='UTF-8';
