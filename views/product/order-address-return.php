                        ...
                        <div class="data_tab_cnt">
                            <div class="fmlz fmlz_adrs">
                                ...
                                <div class="psnl_data_fld">
                                    <div class="psnl_data_gr">
                                        <div class="psnl_data_inp_sel">
                                            <select class="psnl_data_inp ap-n region" name="region">
                                                <?php if(!empty($order->region_id)): ?>
                                                    <option selected><?= $order->rayon->region->region ?></option>
                                                <?php else: ?>
                                    ...
                                    <div class="psnl_data_gr">
                                        <div class="psnl_data_inp_sel">
                                            <select class="psnl_data_inp ap-n rayon"  name="rayon">
                                                <?php if(!empty($order->region_id)): ?>
                                                    <option selected><?= $order->rayon->rayon ?></option>
                                                <?php else:?>
                                    ...
                                    <div class="psnl_data_gr">
                                        <input type="text" class="psnl_data_inp" name="street" value="<?= !empty($order->street) ? $order->street : ''?>" placeholder="<?= Yii::t('app','* Улица') ?>" required>
                                    </div>

                                    <div class="psnl_data_gr multi">
                                        <div class="psnl_data_gr_it">
                                            <input type="text" name="index" value="<?= !empty($order->index) ? $order->index : ''?>"  class="psnl_data_inp" placeholder="<?= Yii::t('app','Индекс') ?>">
                                        </div>

                                        <div class="psnl_data_gr_it">
                                            <input type="text" name="number_dom" value="<?= !empty($order->number_dom) ? $order->number_dom : ''?>" class="psnl_data_inp" placeholder="<?= Yii::t('app','№ Дом') ?>" required>
                                        </div>

                                        <div class="psnl_data_gr_it">
                                            <input type="text" name="number_kv" value="<?= !empty($order->number_kv) ? $order->number_kv : ''?>" class="psnl_data_inp" placeholder="<?= Yii::t('app','№ Квартира') ?>">
                                        </div>
                                    </div>
